...
export function EigenLogo({ size = 24, className, style }: LogoProps) {
  return (
    <svg
      ...
      className={className}
      style={{ color: 'var(--ink-inverse, currentColor)', ...style }}
      aria-hidden="true"
      focusable="false"
    >
      {/* Ghost axes */}
      ...
      {/* Eigenvector */}
      <line x1="32" y1="68" x2="72" y2="30" stroke="currentColor" strokeWidth="1.8" strokeLinecap="square" />
      {/* Arrow chevron */}
      <polyline points="65,29 72,30 68,37" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="square" />
      {/* Scalar ticks */}
      <circle cx="42" cy="58" r="0.8" fill="rgba(255,255,255,0.2)" />
      <circle cx="62" cy="38" r="0.8" fill="rgba(255,255,255,0.2)" />
      {/* Origin crosshair */}
      <circle cx="50" cy="50" r="1.5" fill="none" stroke="currentColor" strokeWidth="0.8" />
...
export function EigenXLogo({ size = 24, className, style }: LogoProps) {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      style={{ color: 'var(--accent-primary, currentColor)', ...style }}
      aria-hidden="true"
      focusable="false"
    >
      <circle cx="50" cy="50" r="36" stroke="currentColor" strokeWidth="1.5" />
      <line x1="25" y1="25" x2="75" y2="75" stroke="currentColor" strokeWidth="1.8" strokeLinecap="square" />
      <line x1="75" y1="25" x2="25" y2="75" stroke="currentColor" strokeWidth="1.8" strokeLinecap="square" />
...
export function EigenXLogoFull({ size = 200, className, style }: LogoProps) {
  ...
  return (
    ...
    >
      ...
      {/* X vectors */}
      <line x1="62" y1="62" x2="138" y2="138" stroke="currentColor" strokeWidth="2" strokeLinecap="square" />
      <line x1="138" y1="62" x2="62" y2="138" stroke="currentColor" strokeWidth="2" strokeLinecap="square" />
      {/* Chevrons */}
      <polyline points="130,60 138,62 132,70" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="square" />
      <polyline points="70,130 62,138 68,140" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="square" />
      <polyline points="70,60 62,62 68,70" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="square" />
      <polyline points="130,140 138,138 132,130" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="square" />
      {/* Center dot + ring */}
...
export function EigenLogoFull({ size = 200, className, style }: LogoProps) {
  ...
  return (
    ...
    >
      ...
      {/* Outer square */}
      <rect x="36" y="36" width="128" height="128" fill="none" stroke="currentColor" strokeWidth="1.5" />
      {/* Inner dashed echo */}
      <rect x="48" y="48" width="104" height="104" fill="none" stroke="rgba(255,255,255,0.07)" strokeWidth="0.8" strokeDasharray="6 14" />
      {/* Eigenvector */}
      <line x1="64" y1="136" x2="144" y2="60" stroke="currentColor" strokeWidth="2" strokeLinecap="square" />
      {/* Arrow chevron */}
      <polyline points="134,58 144,60 138,70" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="square" />
      {/* Scalar ticks */}
      <circle cx="84" cy="116" r="1.2" fill="rgba(255,255,255,0.2)" />
      <circle cx="124" cy="76" r="1.2" fill="rgba(255,255,255,0.2)" />
      {/* Origin crosshair */}
      <circle cx="100" cy="100" r="3" fill="none" stroke="currentColor" strokeWidth="0.8" />
