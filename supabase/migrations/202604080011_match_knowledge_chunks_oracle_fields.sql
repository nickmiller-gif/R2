-- Expose Oracle linkage on chunks returned from ANN retrieval for ranking and future UI.
...
COMMENT ON FUNCTION public.match_knowledge_chunks IS
  'Cosine ANN over knowledge_chunks.embedding (HNSW), temporal bounds, entity/policy overlap; includes oracle_signal_id / oracle_relevance_score for ranking.';
