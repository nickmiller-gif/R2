...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      asset_registry: {
        Row: {
          ...
          provenance_source_type: Database['public']['Enums']['source_type'] | null;
      ...
      documents: {
        Row: {
          ...
          source_authority_tier: Database['public']['Enums']['oracle_authority_tier'] | null;
    ...
    Views: {
      charter_audit_log: {
        Row: {
          ...
          entity_id: string | null;
          entity_kind: Database['public']['Enums']['governance_entity_kind'] | null;
    ...
    Enums: {
      ...
      asset_governance_status: 'local' | 'review' | 'promoted' | 'governed' | 'suspended';
      asset_kind:
        | 'idea_submission'
        | 'document'
        | 'oracle_signal'
      ...
      deal_stage:
        ...
        | 'closed'
        | 'dead';
      deal_type: 'acquisition' | 'disposition' | 'refinance' | 'development' | 'jv';
      ...
      evidence_linked_table:
        ...
        | 'ip_matters'
        | 'asset_valuations';
      evidence_role: 'primary_evidence' | 'supporting_evidence' | 'source_record';
      evidence_status: 'submitted' | 'verified' | 'challenged';
      evidence_type: 'document' | 'photo' | 'filing' | 'testimony';
      extracted_text_status: 'pending' | 'extracted' | 'failed' | 'not_applicable';
      ...
      meg_alias_kind: 'slug' | 'external_id' | 'display_name' | 'shortcode' | 'legal_name' | 'dba';
      meg_edge_type:
        | 'owns'
        | 'employs'
        | 'subsidiary_of'
      ...
      meg_entity_type: 'person' | 'org' | 'property' | 'product' | 'concept' | 'location' | 'ip';
      ...
      oracle_authority_tier:
        ...
        | 'web_search'
        | 'llm_generation';
      oracle_novelty_status: 'new' | 'known' | 'duplicate' | 'near_duplicate' | 'updated_existing';
      oracle_outcome_source: 'manual' | 'automated' | 'external_feed' | 'domain_event';
      ...
      oracle_thesis_evidence_role: 'inspiration' | 'validation' | 'contradiction';
      oracle_thesis_status: 'draft' | 'active' | 'challenged' | 'superseded' | 'retired';
      ...
      source_type: 'manual' | 'import' | 'api' | 'scrape' | 'derived' | 'ai-generated';
      thesis_knowledge_link_status: 'active' | 'superseded' | 'retracted';
      thesis_knowledge_link_type: 'generated' | 'validated' | 'contradicted' | 'refined';
...
export const Constants = {
  public: {
    Enums: {
      ...
      deal_stage: ['prospect', 'underwriting', 'loi', 'due-diligence', 'closing', 'closed', 'dead'],
      deal_type: ['acquisition', 'disposition', 'refinance', 'development', 'jv'],
      decision_linked_table: [
        'entities',
        'rights',
      ...
      oracle_publication_state: ['pending_review', 'approved', 'rejected', 'deferred', 'published'],
      oracle_risk_level: ['low', 'medium', 'high'],
      oracle_run_status: [
        'queued',
        'gathering_evidence',
      ...
      tool_mode: ['read', 'write'],
      tower_lease_type: ['ground-lease', 'rooftop', 'tower'],
      verification_verdict: ['verified', 'partially_verified', 'unverified', 'refuted', 'skipped'],
      visibility_level: ['public', 'authenticated', 'internal', 'confidential'],
    },
  },
} as const;
