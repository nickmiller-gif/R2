...
export function mapSmartplrxTrendToEigen(event: SmartplrxTrendEvent): EigenIngestRequest {
  ...
  return {
    ...
    policy_tags: visibilityPolicyTags(visibility, [
      'smartplrx',
      'trend-intelligence',
      ...(event.tags ?? []),
    ]),
...
export function createSmartplrxEigenAdapter(config: EigenIngestClientConfig) {
